...
8. Aclaración: generalmente se utiliza Swagger para probar y documentar la API interactuando desde el frontend con una base de datos de prueba, pero nosotros en el curso no creamos una base de datos de prueba, así que cuando ejecute los  métodos va a modificar la base de datos de mi aplicación
